...
number_tuples = 1000000
num_repeats = number_tuples / df.shape[0] + 1 # get the number of repeats for parameter
newdf = pd.DataFrame(np.repeat(df.values,num_repeats,axis=0))

newdf.to_csv(r'anime_augmented.csv', index = False, header=True)
